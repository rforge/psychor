...
I order to solve the constrained optimization of $\lambda(x,y)$ over the vectors $(x,y)$ satisfying the conditions above we form the Lagrangian using
...
res
plot(res, plot.type = "jointplot", xlim = c(-2,1.5), ylim = c(-2, 1.5))
